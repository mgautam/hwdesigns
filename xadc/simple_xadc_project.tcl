...
#
# simple_xadc_project.tcl: Tcl script for re-creating project 'xadc'
#
# Generated by Vivado on Wed Jan 15 14:41:42 +1100 2020
...
#
# 1. This project restoration tcl script (simple_xadc_project.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/Gautam/Vivado/xadc/xadc.srcs/sources_1/bd/xadc_design/hdl/xadc_design_wrapper.v"
#    "C:/Users/Gautam/Vivado/xadc/xadc.srcs/constrs_1/new/contraints.xdc"
#
...
set script_file "simple_xadc_project.tcl"
...
set files [list \
 "[file normalize "$origin_dir/xadc.srcs/sources_1/bd/xadc_design/hdl/xadc_design_wrapper.v"]"\
]
...
set file "hdl/xadc_design_wrapper.v"
...
set_property -name "top" -value "xadc_design_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/xadc.srcs/constrs_1/new/contraints.xdc"]"
set file_imported [import_files -fileset constrs_1 $file]
set file "new/contraints.xdc"
...
set_property -name "target_constrs_file" -value "[get_files *new/contraints.xdc]" -objects $obj
...
# Proc to create BD xadc_design
proc cr_bd_xadc_design { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name xadc_design
  ...
  # Create ports
  set do_out_0 [ create_bd_port -dir O -from 15 -to 0 do_out_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_SLOT_0_INTF_TYPE {xilinx.com:interface:diff_analog_io_rtl:1.0} \
   CONFIG.C_SLOT_0_TYPE {0} \
   CONFIG.C_SLOT_1_INTF_TYPE {xilinx.com:interface:diff_analog_io_rtl:1.0} \
   CONFIG.C_SLOT_1_TYPE {0} \
   CONFIG.C_SLOT_2_INTF_TYPE {xilinx.com:interface:diff_analog_io_rtl:1.0} \
   CONFIG.C_SLOT_2_TYPE {0} \
   CONFIG.C_SLOT_3_INTF_TYPE {xilinx.com:interface:diff_analog_io_rtl:1.0} \
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins system_ila_0/probe3] [get_bd_pins xadc_wiz_0/dclk_in]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins system_ila_0/clk]
  connect_bd_net -net xadc_wiz_0_busy_out [get_bd_pins system_ila_0/probe4] [get_bd_pins xadc_wiz_0/busy_out]
  connect_bd_net -net xadc_wiz_0_channel_out [get_bd_pins system_ila_0/probe1] [get_bd_pins xadc_wiz_0/channel_out] [get_bd_pins xlconcat_0/In0]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets xadc_wiz_0_channel_out]
  connect_bd_net -net xadc_wiz_0_do_out [get_bd_ports do_out_0] [get_bd_pins system_ila_0/probe2] [get_bd_pins xadc_wiz_0/do_out]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets xadc_wiz_0_do_out]
  connect_bd_net -net xadc_wiz_0_drdy_out [get_bd_pins system_ila_0/probe6] [get_bd_pins xadc_wiz_0/drdy_out]
  connect_bd_net -net xadc_wiz_0_eoc_out [get_bd_pins system_ila_0/probe0] [get_bd_pins xadc_wiz_0/den_in] [get_bd_pins xadc_wiz_0/eoc_out]
  connect_bd_net -net xadc_wiz_0_eos_out [get_bd_pins system_ila_0/probe5] [get_bd_pins xadc_wiz_0/eos_out]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins system_ila_0/probe7] [get_bd_pins xadc_wiz_0/daddr_in] [get_bd_pins xlconcat_0/dout]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net xlconstant_2_dout [get_bd_pins xadc_wiz_0/reset_in] [get_bd_pins xlconstant_2/dout]
...
# End of cr_bd_xadc_design()
cr_bd_xadc_design ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files xadc_design.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files xadc_design.bd ] 
set_property IS_ENABLED "1" [get_files xadc_design.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files xadc_design.bd ] 
set_property IS_LOCKED "0" [get_files xadc_design.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files xadc_design.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files xadc_design.bd ] 
set_property PFM_NAME "" [get_files xadc_design.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files xadc_design.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files xadc_design.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files xadc_design.bd ] 
set_property USED_IN_SIMULATION "1" [get_files xadc_design.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files xadc_design.bd ] 
