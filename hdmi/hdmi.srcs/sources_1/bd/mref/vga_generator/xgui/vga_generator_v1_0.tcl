...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "H_ACTIVE_VIDEO" -parent ${Page_0}
  ...
  ipgui::add_param $IPINST -name "V_ACTIVE_VIDEO" -parent ${Page_0}
...
proc update_PARAM_VALUE.H_ACTIVE_VIDEO { PARAM_VALUE.H_ACTIVE_VIDEO } {
	# Procedure called to update H_ACTIVE_VIDEO when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.H_ACTIVE_VIDEO { PARAM_VALUE.H_ACTIVE_VIDEO } {
	# Procedure called to validate H_ACTIVE_VIDEO
	return true
}
...
proc update_PARAM_VALUE.V_ACTIVE_VIDEO { PARAM_VALUE.V_ACTIVE_VIDEO } {
	# Procedure called to update V_ACTIVE_VIDEO when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.V_ACTIVE_VIDEO { PARAM_VALUE.V_ACTIVE_VIDEO } {
	# Procedure called to validate V_ACTIVE_VIDEO
	return true
}
...
proc update_MODELPARAM_VALUE.H_ACTIVE_VIDEO { MODELPARAM_VALUE.H_ACTIVE_VIDEO PARAM_VALUE.H_ACTIVE_VIDEO } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.H_ACTIVE_VIDEO}] ${MODELPARAM_VALUE.H_ACTIVE_VIDEO}
}
...
proc update_MODELPARAM_VALUE.V_ACTIVE_VIDEO { MODELPARAM_VALUE.V_ACTIVE_VIDEO PARAM_VALUE.V_ACTIVE_VIDEO } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.V_ACTIVE_VIDEO}] ${MODELPARAM_VALUE.V_ACTIVE_VIDEO}
}
