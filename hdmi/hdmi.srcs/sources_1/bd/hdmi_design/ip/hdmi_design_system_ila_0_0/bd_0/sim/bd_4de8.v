...
module bd_4de8
   (clk,
    ...
    probe8,
    probe9);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, CLK_DOMAIN /clk_wiz_0_clk_out1, FREQ_HZ 400000000, PHASE 0.0" *) input clk;
  input [0:0]probe0;
  input [0:0]probe1;
  input [9:0]probe10;
  input [7:0]probe11;
