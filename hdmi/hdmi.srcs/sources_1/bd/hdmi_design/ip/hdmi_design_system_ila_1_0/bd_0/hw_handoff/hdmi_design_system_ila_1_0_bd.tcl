...
################################################################
# This is a generated script based on design: bd_8db9
#
...
proc create_root_design { parentCell } {
  ...
  set probe5 [ create_bd_port -dir I -from 9 -to 0 probe5 ]
  set probe6 [ create_bd_port -dir I -from 9 -to 0 probe6 ]
  set probe7 [ create_bd_port -dir I -from 8 -to 0 probe7 ]
  set probe8 [ create_bd_port -dir I -from 9 -to 0 probe8 ]
