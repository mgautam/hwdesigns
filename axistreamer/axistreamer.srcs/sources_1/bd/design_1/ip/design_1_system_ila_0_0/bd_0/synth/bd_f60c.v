...
module bd_f60c
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXIS:SLOT_1_AXI, ASSOCIATED_RESET resetn, CLK_DOMAIN design_1_processing_system7_0_0_FCLK_CLK0, FREQ_HZ 5e+07, PHASE 0.000" *) input clk;
  input [0:0]probe0;
  ...
  bd_f60c_ila_lib_1 ila_lib
       (.clk(clk_1),
        .probe0(probe0_1),
        .probe1(net_slot_0_axis_tdata),
        .probe10(net_slot_1_axi_aw_cnt),
        .probe11(net_slot_1_axi_awaddr),
        .probe12(net_slot_1_axi_awlen),
        .probe13(net_slot_1_axi_awsize),
        .probe14(net_slot_1_axi_b_cnt),
        .probe15(net_slot_1_axi_bresp),
        .probe16(net_slot_1_axi_r_cnt),
        .probe17(net_slot_1_axi_rdata),
        .probe18(net_slot_1_axi_wdata),
        .probe19(net_slot_1_axi_wstrb),
        .probe2(net_slot_0_axis_tstrb),
        .probe20(net_slot_1_axi_aw_ctrl),
        .probe21(net_slot_1_axi_w_ctrl),
        .probe22(net_slot_1_axi_b_ctrl),
        .probe23(net_slot_1_axi_ar_ctrl),
        .probe24(net_slot_1_axi_r_ctrl),
