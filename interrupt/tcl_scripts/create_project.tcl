...
#
# create_project.tcl: Tcl script for re-creating project 'zybointerrupt'
#
# Generated by Vivado on Wed Sep 16 15:22:49 +1000 2020
...
#
#    "C:/Users/Gautam/Vivado/zybointerrupt/zybointerrupt.srcs/sources_1/bd/interrupt_design/hdl/interrupt_design_wrapper.v"
#    "C:/Users/Gautam/Vivado/zybointerrupt/zybointerrupt.srcs/constrs_1/new/pin_constraints.xdc"
#
...
set project_name "zybointerrupt"
...
set files [list \
 "[file normalize "$origin_dir/../zybointerrupt.srcs/sources_1/bd/interrupt_design/hdl/interrupt_design_wrapper.v"]"\
]
...
set file "hdl/interrupt_design_wrapper.v"
...
set_property -name "top" -value "interrupt_design_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/../zybointerrupt.srcs/constrs_1/new/pin_constraints.xdc"]"
set file_imported [import_files -fileset constrs_1 $file]
set file "new/pin_constraints.xdc"
...
set_property -name "target_constrs_file" -value "[get_files *new/pin_constraints.xdc]" -objects $obj
...
# Proc to create BD interrupt_design
proc cr_bd_interrupt_design { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name interrupt_design
...
# End of cr_bd_interrupt_design()
cr_bd_interrupt_design ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files interrupt_design.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files interrupt_design.bd ] 
set_property IS_ENABLED "1" [get_files interrupt_design.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files interrupt_design.bd ] 
set_property IS_LOCKED "0" [get_files interrupt_design.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files interrupt_design.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files interrupt_design.bd ] 
set_property PFM_NAME "" [get_files interrupt_design.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files interrupt_design.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files interrupt_design.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files interrupt_design.bd ] 
set_property USED_IN_SIMULATION "1" [get_files interrupt_design.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files interrupt_design.bd ] 
