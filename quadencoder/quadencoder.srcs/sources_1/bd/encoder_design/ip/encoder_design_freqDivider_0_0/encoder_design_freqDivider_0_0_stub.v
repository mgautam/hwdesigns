...
module encoder_design_freqDivider_0_0(clk, enable, divisor, clk_out, cnter)
/* synthesis syn_black_box black_box_pad_pin="clk,enable,divisor[4:0],clk_out,cnter[31:0]" */;
  input clk;
  input enable;
  input [4:0]divisor;
  output clk_out;
