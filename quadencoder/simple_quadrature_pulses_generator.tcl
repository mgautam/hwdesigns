...
#
# simple_quadrature_pulses_generator.tcl: Tcl script for re-creating project 'quadencoder'
#
# Generated by Vivado on Tue Dec 10 19:43:12 +1100 2019
...
#
# 1. This project restoration tcl script (simple_quadrature_pulses_generator.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/Gautam/Vivado/quadencoder/quadencoder.srcs/sources_1/new/freqDivider.v"
#    "C:/Users/Gautam/Vivado/quadencoder/quadencoder.srcs/sources_1/new/clkToQuad.v"
#    "C:/Users/Gautam/Vivado/quadencoder/quadencoder.srcs/sources_1/new/binary_counter.v"
#    "C:/Users/Gautam/Vivado/quadencoder/quadencoder.srcs/sources_1/bd/encoder_design/hdl/encoder_design_wrapper.v"
#    "C:/Users/Gautam/Vivado/quadencoder/quadencoder.srcs/constrs_1/new/constraints.xdc"
#
...
set script_file "simple_quadrature_pulses_generator.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../../../Vivado/quadencoder"]"
...
set files [list \
 "[file normalize "$origin_dir/../../../Vivado/quadencoder/quadencoder.srcs/sources_1/new/freqDivider.v"]"\
 "[file normalize "$origin_dir/../../../Vivado/quadencoder/quadencoder.srcs/sources_1/new/clkToQuad.v"]"\
 "[file normalize "$origin_dir/../../../Vivado/quadencoder/quadencoder.srcs/sources_1/new/binary_counter.v"]"\
 "[file normalize "$origin_dir/../../../Vivado/quadencoder/quadencoder.srcs/sources_1/bd/encoder_design/hdl/encoder_design_wrapper.v"]"\
]
...
set file "hdl/encoder_design_wrapper.v"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set_property -name "top" -value "encoder_design_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/../../../Vivado/quadencoder/quadencoder.srcs/constrs_1/new/constraints.xdc"]"
...
if { [get_files freqDivider.v] == "" } {
  import_files -quiet -fileset sources_1 C:/Users/Gautam/Vivado/quadencoder/quadencoder.srcs/sources_1/new/freqDivider.v
}
if { [get_files clkToQuad.v] == "" } {
  import_files -quiet -fileset sources_1 C:/Users/Gautam/Vivado/quadencoder/quadencoder.srcs/sources_1/new/clkToQuad.v
}
if { [get_files binary_counter.v] == "" } {
  import_files -quiet -fileset sources_1 C:/Users/Gautam/Vivado/quadencoder/quadencoder.srcs/sources_1/new/binary_counter.v
}


# Proc to create BD encoder_design
proc cr_bd_encoder_design { parentCell } {
...
# End of cr_bd_encoder_design()
cr_bd_encoder_design ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files encoder_design.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files encoder_design.bd ] 
set_property IS_ENABLED "1" [get_files encoder_design.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files encoder_design.bd ] 
set_property IS_LOCKED "0" [get_files encoder_design.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files encoder_design.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files encoder_design.bd ] 
set_property PFM_NAME "" [get_files encoder_design.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files encoder_design.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files encoder_design.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files encoder_design.bd ] 
set_property USED_IN_SIMULATION "1" [get_files encoder_design.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files encoder_design.bd ] 
