...
#
# vga_project.tcl: Tcl script for re-creating project 'vga'
#
# Generated by Vivado on Fri Dec 27 03:24:58 +1100 2019
...
#
# 1. This project restoration tcl script (vga_project.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/Gautam/Vivado/vga/vga.srcs/sources_1/new/vga_generator.v"
#    "C:/Users/Gautam/Vivado/vga/vga.srcs/sources_1/bd/vga_design/hdl/vga_design_wrapper.v"
#    "C:/Users/Gautam/Vivado/vga/vga.srcs/constrs_1/new/constraints.xdc"
#    "C:/Users/Gautam/Vivado/vga/vga.srcs/sim_1/new/testbench.v"
#
...
set script_file "vga_project.tcl"
...
set files [list \
 "[file normalize "$origin_dir/vga.srcs/sources_1/new/vga_generator.v"]"\
 "[file normalize "$origin_dir/vga.srcs/sources_1/bd/vga_design/hdl/vga_design_wrapper.v"]"\
]
...
set file "hdl/vga_design_wrapper.v"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
# Import local files from the original project
set files [list \
 "[file normalize "$origin_dir/vga.srcs/sim_1/new/testbench.v"]"\
]
...
if { [get_files vga_generator.v] == "" } {
  import_files -quiet -fileset sources_1 C:/Users/Gautam/Vivado/vga/vga.srcs/sources_1/new/vga_generator.v
}


# Proc to create BD vga_design
proc cr_bd_vga_design { parentCell } {
...
# End of cr_bd_vga_design()
cr_bd_vga_design ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files vga_design.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files vga_design.bd ] 
set_property IS_ENABLED "1" [get_files vga_design.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files vga_design.bd ] 
set_property IS_LOCKED "0" [get_files vga_design.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files vga_design.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files vga_design.bd ] 
set_property PFM_NAME "" [get_files vga_design.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files vga_design.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files vga_design.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files vga_design.bd ] 
set_property USED_IN_SIMULATION "1" [get_files vga_design.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files vga_design.bd ] 
