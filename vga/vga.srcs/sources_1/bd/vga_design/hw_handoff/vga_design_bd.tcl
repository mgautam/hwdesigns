...
################################################################
# This is a generated script based on design: vga_design
#
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set blue_0 [ create_bd_port -dir O -from 7 -to 0 blue_0 ]
  set hsync_0 [ create_bd_port -dir O hsync_0 ]
  set video_on_0 [ create_bd_port -dir O video_on_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_FPGA0_PERIPHERAL_FREQMHZ {25.175} \
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins vga_generator_0/clk]
  connect_bd_net -net vga_generator_0_blue [get_bd_ports blue_0] [get_bd_pins vga_generator_0/blue]
  connect_bd_net -net vga_generator_0_hsync [get_bd_ports hsync_0] [get_bd_pins vga_generator_0/hsync]
  connect_bd_net -net vga_generator_0_video_on [get_bd_ports video_on_0] [get_bd_pins vga_generator_0/video_on]
  connect_bd_net -net vga_generator_0_vsync [get_bd_ports vsync_0] [get_bd_pins vga_generator_0/vsync]
