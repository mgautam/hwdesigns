...
#
# simple_audio_project.tcl: Tcl script for re-creating project 'audio'
#
# Generated by Vivado on Sun Jan 05 02:19:07 +1100 2020
...
#
# 1. This project restoration tcl script (simple_audio_project.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/Gautam/Vivado/audio/audio.srcs/sources_1/new/audio_generator.v"
#    "C:/Users/Gautam/Vivado/audio/audio.srcs/sources_1/bd/audio_design/hdl/audio_design_wrapper.v"
#    "C:/Users/Gautam/Vivado/audio/audio.srcs/constrs_1/new/constraints.xdc"
#
...
set script_file "simple_audio_project.tcl"
...
set files [list \
 "[file normalize "$origin_dir/audio.srcs/sources_1/new/audio_generator.v"]"\
 "[file normalize "$origin_dir/audio.srcs/sources_1/bd/audio_design/hdl/audio_design_wrapper.v"]"\
]
...
set file "new/audio_generator.v"
...
set file "hdl/audio_design_wrapper.v"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set_property -name "top" -value "audio_design_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/audio.srcs/constrs_1/new/constraints.xdc"]"
...
if { [get_files audio_generator.v] == "" } {
  import_files -quiet -fileset sources_1 C:/Users/Gautam/Vivado/audio/audio.srcs/sources_1/new/audio_generator.v
}


# Proc to create BD audio_design
proc cr_bd_audio_design { parentCell } {
...
# audio_generator
  ...
  # Create instance: audio_generator_0, and set properties
  set block_name audio_generator
  set block_cell_name audio_generator_0
  if { [catch {set audio_generator_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $audio_generator_0 eq "" } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT1_JITTER {373.299} \
   CONFIG.CLKOUT1_PHASE_ERROR {409.976} \
   ...
   CONFIG.MMCM_CLKFBOUT_MULT_F {61.000} \
   CONFIG.MMCM_CLKIN1_PERIOD {20.000} \
   CONFIG.MMCM_CLKIN2_PERIOD {10.0} \
   CONFIG.MMCM_CLKOUT0_DIVIDE_F {82.750} \
  ...
  connect_bd_net -net RECDAT_1 [get_bd_ports RECDAT] [get_bd_pins audio_generator_0/recdat] [get_bd_pins system_ila_0/probe5]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets RECDAT_1]
  connect_bd_net -net audio_generator_0_bclk [get_bd_ports BCLK] [get_bd_pins audio_generator_0/bclk] [get_bd_pins system_ila_0/probe1]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets audio_generator_0_bclk]
  connect_bd_net -net audio_generator_0_lrc_counter [get_bd_pins audio_generator_0/lrc_counter] [get_bd_pins system_ila_0/probe3]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets audio_generator_0_lrc_counter]
  connect_bd_net -net audio_generator_0_mclk [get_bd_ports MCLK] [get_bd_pins audio_generator_0/mclk] [get_bd_pins system_ila_0/probe0]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets audio_generator_0_mclk]
  connect_bd_net -net audio_generator_0_mute [get_bd_ports MUTE] [get_bd_pins audio_generator_0/mute]
  connect_bd_net -net audio_generator_0_pbdat [get_bd_ports PBDAT] [get_bd_pins audio_generator_0/pbdat] [get_bd_pins system_ila_0/probe2]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets audio_generator_0_pbdat]
  connect_bd_net -net audio_generator_0_pblrc [get_bd_ports PBLRC] [get_bd_ports RECLRC] [get_bd_pins audio_generator_0/pbreclrc] [get_bd_pins system_ila_0/probe4]
  connect_bd_net -net audio_generator_0_recdata [get_bd_pins audio_generator_0/recdata] [get_bd_pins system_ila_0/probe6]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets audio_generator_0_recdata]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins audio_generator_0/clk] [get_bd_pins clk_wiz_0/clk_out1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins system_ila_0/clk]
...
# End of cr_bd_audio_design()
cr_bd_audio_design ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files audio_design.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files audio_design.bd ] 
set_property IS_ENABLED "1" [get_files audio_design.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files audio_design.bd ] 
set_property IS_LOCKED "0" [get_files audio_design.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files audio_design.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files audio_design.bd ] 
set_property PFM_NAME "" [get_files audio_design.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files audio_design.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files audio_design.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files audio_design.bd ] 
set_property USED_IN_SIMULATION "1" [get_files audio_design.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files audio_design.bd ] 
