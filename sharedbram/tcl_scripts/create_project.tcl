...
#
# create_project.tcl: Tcl script for re-creating project 'sharedbram'
#
# Generated by Vivado on Wed Sep 16 02:58:58 AEST 2020
...
#
#    "/home/gautam/Vivado/sharedbram/sharedbram.srcs/sources_1/bd/bram_design/hdl/bram_design_wrapper.v"
#    "/home/gautam/Vivado/sharedbram/sharedbram.srcs/constrs_1/new/pinconstraints.xdc"
#
...
set _xil_proj_name_ "sharedbram"
...
set files [list \
 [file normalize "${origin_dir}/../sharedbram.srcs/sources_1/bd/bram_design/hdl/bram_design_wrapper.v" ]\
]
...
set file "hdl/bram_design_wrapper.v"
...
set_property -name "top" -value "bram_design_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/../sharedbram.srcs/constrs_1/new/pinconstraints.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "new/pinconstraints.xdc"
...
set_property -name "target_constrs_file" -value "[get_files *new/pinconstraints.xdc]" -objects $obj
set_property -name "target_ucf" -value "[get_files *new/pinconstraints.xdc]" -objects $obj
...
# Proc to create BD bram_design
proc cr_bd_bram_design { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name bram_design
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_smc_M00_AXI] [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins ila_1/SLOT_0_AXI]
  ...
  connect_bd_net -net Net [get_bd_pins axi_bram_ctrl_0/bram_addr_a] [get_bd_pins axi_bram_ctrl_0_bram/addra] [get_bd_pins ila_0/probe0]
  connect_bd_net -net Net1 [get_bd_pins axi_bram_ctrl_0/bram_clk_a] [get_bd_pins axi_bram_ctrl_0_bram/clka] [get_bd_pins ila_0/probe1]
  connect_bd_net -net Net2 [get_bd_pins axi_bram_ctrl_0/bram_wrdata_a] [get_bd_pins axi_bram_ctrl_0_bram/dina] [get_bd_pins ila_0/probe2]
  connect_bd_net -net Net3 [get_bd_pins axi_bram_ctrl_0/bram_en_a] [get_bd_pins axi_bram_ctrl_0_bram/ena] [get_bd_pins ila_0/probe4] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net Net4 [get_bd_pins axi_bram_ctrl_0/bram_rst_a] [get_bd_pins axi_bram_ctrl_0_bram/rsta] [get_bd_pins ila_0/probe5] [get_bd_pins ila_0/probe6]
  connect_bd_net -net Net5 [get_bd_pins axi_bram_ctrl_0/bram_we_a] [get_bd_pins axi_bram_ctrl_0_bram/wea] [get_bd_pins ila_0/probe7]
  connect_bd_net -net axi_bram_ctrl_0_bram_douta [get_bd_pins axi_bram_ctrl_0/bram_rddata_a] [get_bd_pins axi_bram_ctrl_0_bram/douta] [get_bd_pins ila_0/probe3]
  connect_bd_net -net axi_bram_ctrl_0_bram_doutb [get_bd_pins axi_bram_ctrl_0_bram/doutb] [get_bd_pins ila_0/probe8]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_0_bram/clkb] [get_bd_pins axi_smc/aclk] [get_bd_pins ila_1/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins ila_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK1]
  ...
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins axi_bram_ctrl_0_bram/enb] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net web_0_1 [get_bd_ports web_0] [get_bd_pins axi_bram_ctrl_0_bram/web]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins axi_bram_ctrl_0_bram/addrb] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_2_dout [get_bd_pins axi_bram_ctrl_0_bram/rstb] [get_bd_pins xlconstant_2/dout]
  connect_bd_net -net xlconstant_4_dout [get_bd_pins axi_bram_ctrl_0_bram/dinb] [get_bd_pins xlconstant_4/dout]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"2.12136",
   "Default View_TopLeft":"344,192",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:9.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 5 -x 1540 -y 380 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 5 -x 1540 -y 850 -defaultsOSRD
preplace portBus web_0 -pg 1 -lvl 0 -x 0 -y 840 -defaultsOSRD
preplace inst axi_bram_ctrl_0 -pg 1 -lvl 3 -x 990 -y 250 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 250 -y 430 -defaultsOSRD
preplace inst axi_bram_ctrl_0_bram -pg 1 -lvl 4 -x 1390 -y 590 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 2 -x 640 -y 300 -defaultsOSRD
preplace inst rst_ps7_0_50M -pg 1 -lvl 1 -x 250 -y 940 -defaultsOSRD
preplace inst xlconstant_0 -pg 1 -lvl 3 -x 990 -y 460 -defaultsOSRD
preplace inst xlconstant_2 -pg 1 -lvl 3 -x 990 -y 780 -defaultsOSRD
preplace inst ila_0 -pg 1 -lvl 4 -x 1390 -y 230 -defaultsOSRD
preplace inst xlconstant_4 -pg 1 -lvl 3 -x 990 -y 580 -defaultsOSRD
preplace inst ila_1 -pg 1 -lvl 3 -x 990 -y 70 -defaultsOSRD
preplace inst util_vector_logic_0 -pg 1 -lvl 3 -x 990 -y 680 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 4 20 560 500 390 800 520 1170J
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 30 570 470
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 1 2 490 220 790
preplace netloc Net 1 3 1 1190 160n
preplace netloc Net1 1 3 1 1200 180n
preplace netloc Net2 1 3 1 1210 200n
preplace netloc axi_bram_ctrl_0_bram_douta 1 3 1 1220 220n
preplace netloc Net3 1 2 2 820 400 1230
preplace netloc Net4 1 3 1 1240 260n
preplace netloc Net5 1 3 1 1250 300n
preplace netloc xlconstant_0_dout 1 3 1 1180J 460n
preplace netloc xlconstant_2_dout 1 3 1 1190J 720n
preplace netloc processing_system7_0_FCLK_CLK1 1 1 3 NJ 480 810J 390 1170
preplace netloc xlconstant_4_dout 1 3 1 1160J 580n
preplace netloc axi_bram_ctrl_0_bram_doutb 1 3 1 1260 320n
preplace netloc web_0_1 1 0 4 NJ 840 NJ 840 NJ 840 1250J
preplace netloc util_vector_logic_0_Res 1 3 1 1200J 680n
preplace netloc processing_system7_0_DDR 1 1 4 NJ 380 NJ 380 NJ 380 NJ
preplace netloc processing_system7_0_FIXED_IO 1 1 4 480J 850 NJ 850 NJ 850 NJ
preplace netloc axi_bram_ctrl_0_BRAM_PORTA 1 3 1 1180 180n
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 470 280n
preplace netloc axi_smc_M00_AXI 1 2 1 780 60n
levelinfo -pg 1 0 250 640 990 1390 1540
pagesize -pg 1 -db -bbox -sgen -130 0 1660 1040
"
}
...
# End of cr_bd_bram_design()
cr_bd_bram_design ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files bram_design.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files bram_design.bd ] 
set_property IS_ENABLED "1" [get_files bram_design.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files bram_design.bd ] 
set_property IS_LOCKED "0" [get_files bram_design.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files bram_design.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files bram_design.bd ] 
set_property PFM_NAME "" [get_files bram_design.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files bram_design.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files bram_design.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files bram_design.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files bram_design.bd ] 
set_property USED_IN_SIMULATION "1" [get_files bram_design.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files bram_design.bd ] 
