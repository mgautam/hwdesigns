...
#
# create_project.tcl: Tcl script for re-creating project 'analogspi'
#
# Generated by Vivado on Thu Sep 24 22:27:06 +1000 2020
...
#
#    "C:/Users/Gautam/Vivado/zybo/analogspi/analogspi.srcs/sources_1/new/risingedge.v"
#    "C:/Users/Gautam/Vivado/zybo/analogspi/analogspi.srcs/sources_1/new/spigenerator.v"
#    "C:/Users/Gautam/Vivado/zybo/analogspi/analogspi.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"
#    "C:/Users/Gautam/Vivado/zybo/analogspi/analogspi.srcs/constrs_1/new/pinconstraints.xdc"
#
...
set files [list \
 [file normalize "${origin_dir}/../analogspi.srcs/sources_1/new/risingedge.v" ]\
 [file normalize "${origin_dir}/../analogspi.srcs/sources_1/new/spigenerator.v" ]\
 [file normalize "${origin_dir}/../analogspi.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]\
]
...
set file "[file normalize "$origin_dir/../analogspi.srcs/constrs_1/new/pinconstraints.xdc"]"
...
if { [get_files risingedge.v] == "" } {
  import_files -quiet -fileset sources_1 C:/Users/Gautam/Vivado/zybo/analogspi/analogspi.srcs/sources_1/new/risingedge.v
}
if { [get_files spigenerator.v] == "" } {
  import_files -quiet -fileset sources_1 C:/Users/Gautam/Vivado/zybo/analogspi/analogspi.srcs/sources_1/new/spigenerator.v
}
...
# risingedge, spigenerator
  ...
  # Create instance: risingedge_0, and set properties
  set block_name risingedge
  set block_cell_name risingedge_0
  if { [catch {set risingedge_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $risingedge_0 eq "" } {
  ...
  # Create instance: spigenerator_0, and set properties
  set block_name spigenerator
  set block_cell_name spigenerator_0
  if { [catch {set spigenerator_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $spigenerator_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net axi_gpio_0_gpio2_io_o [get_bd_pins axi_gpio_0/gpio2_io_o] [get_bd_pins risingedge_0/inword]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins spigenerator_0/inword]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins ila_0/probe0] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins risingedge_0/clk] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins spigenerator_0/clk]
  ...
  connect_bd_net -net risingedge_0_q [get_bd_pins ila_0/probe4] [get_bd_pins risingedge_0/q] [get_bd_pins spigenerator_0/send_trigger]
  ...
  connect_bd_net -net spigenerator_0_mosi [get_bd_ports io0_o_0] [get_bd_pins ila_0/probe2] [get_bd_pins spigenerator_0/mosi]
  connect_bd_net -net spigenerator_0_negcntr [get_bd_pins ila_0/probe7] [get_bd_pins spigenerator_0/negcntr]
  connect_bd_net -net spigenerator_0_poscntr [get_bd_pins ila_0/probe5] [get_bd_pins spigenerator_0/poscntr]
  connect_bd_net -net spigenerator_0_sclk [get_bd_ports sck_o_0] [get_bd_pins ila_0/probe1] [get_bd_pins spigenerator_0/sclk]
  connect_bd_net -net spigenerator_0_sent_interrupt [get_bd_pins ila_0/probe6] [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins spigenerator_0/sent_interrupt]
  connect_bd_net -net spigenerator_0_ss [get_bd_ports ss_o_0] [get_bd_pins ila_0/probe3] [get_bd_pins spigenerator_0/ss]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_TopLeft":"-172,-7",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r6  2020-01-29 bk=1.5227 VDI=41 GEI=36 GUI=JA:9.0 non-TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 4 -x 1160 -y 610 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 4 -x 1160 -y 630 -defaultsOSRD
preplace port sck_o_0 -pg 1 -lvl 4 -x 1160 -y 290 -defaultsOSRD
preplace port io0_o_0 -pg 1 -lvl 4 -x 1160 -y 310 -defaultsOSRD
preplace portBus ss_o_0 -pg 1 -lvl 4 -x 1160 -y 590 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 240 -y 670 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -x 640 -y 140 -defaultsOSRD
preplace inst rst_ps7_0_50M -pg 1 -lvl 1 -x 240 -y 180 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 3 -x 990 -y 170 -defaultsOSRD
preplace inst risingedge_0 -pg 1 -lvl 1 -x 240 -y 350 -defaultsOSRD
preplace inst ila_0 -pg 1 -lvl 3 -x 990 -y 450 -defaultsOSRD
preplace inst spigenerator_0 -pg 1 -lvl 2 -x 640 -y 420 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 420 470 300 850
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 30 430 440
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 1 2 480 310 830J
preplace netloc axi_gpio_0_gpio_io_o 1 1 3 490 290 810J 80 1130
preplace netloc axi_gpio_0_gpio2_io_o 1 0 4 40 280 NJ 280 800J 70 1140
preplace netloc spigenerator_0_sent_interrupt 1 0 3 40 550 NJ 550 790
preplace netloc processing_system7_0_FCLK_CLK1 1 1 2 480 530 830J
preplace netloc spigenerator_0_sclk 1 2 2 820 290 NJ
preplace netloc spigenerator_0_mosi 1 2 2 840 310 NJ
preplace netloc spigenerator_0_ss 1 2 2 810 590 NJ
preplace netloc spigenerator_0_poscntr 1 2 1 820 430n
preplace netloc spigenerator_0_negcntr 1 2 1 800 450n
preplace netloc risingedge_0_q 1 1 2 460 540 840J
preplace netloc processing_system7_0_FIXED_IO 1 1 3 NJ 630 NJ 630 NJ
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 450 60n
preplace netloc ps7_0_axi_periph_M01_AXI 1 2 1 N 150
preplace netloc processing_system7_0_DDR 1 1 3 NJ 610 NJ 610 NJ
levelinfo -pg 1 0 240 640 990 1160
pagesize -pg 1 -db -bbox -sgen 0 0 1290 790
"
}
